...
/* Constantes con los elementos que vamos a usar del HTML */

const list_data = document.querySelector('.js_list_data');
const menuDropdown = document.querySelector('.js_menu_dropdown');
const boxAdd = document.querySelector('.js_add_box');
const board_data = document.querySelector('.js_boarddata');
...
/* Mostrar formulario nuevo bookmark */
